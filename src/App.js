          ...
          <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div className="row">
              <div className="col-lg-6">
                <ul>
                  <li><i className="bi bi-chevron-right" /> <strong>Birthday:</strong> <span>30 May 2004</span></li>
                  <li><i className="bi bi-chevron-right" /> <strong>Website:</strong> <span>abhishekok.netlify.com</span></li>
                  <li><i className="bi bi-chevron-right" /> <strong>Phone:</strong> <span>9669275420</span></li>
                  <li><i className="bi bi-chevron-right" /> <strong>City:</strong> <span>Neemuch, MP</span></li>
                </ul>
              </div>
              <div className="col-lg-6">
                <ul>
                  ...
                  <li><i className="bi bi-chevron-right" /> <strong>PhEmailone:</strong> <span>abhisheksuthar9669@.com</span></li>
